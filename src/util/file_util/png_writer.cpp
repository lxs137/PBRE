...
unsigned int crc32(const unsigned char *data, int length)
{
...
unsigned char* get_png_file_data(int png_x, int png_y, unsigned char *image_data, int *file_data_len) {
    ...
    *file_data_len = 8 + 25 + 12+IDAT_len + 12;
    ...
    WRITE_DATA_1(write_ptr,137);
    WRITE_DATA_1(write_ptr,80);
    WRITE_DATA_1(write_ptr,78);
    WRITE_DATA_1(write_ptr,71);
    WRITE_DATA_1(write_ptr,13);
    ...
    WRITE_DATA_1(write_ptr,'R');
    // 图像的宽和高
    WRITE_DATA_4(write_ptr,png_x);
    WRITE_DATA_4(write_ptr,png_y);
    // 真彩色图像, 不使用颜色索引
    WRITE_DATA_1(write_ptr,8);
    WRITE_DATA_1(write_ptr,2);
    ...
    WRITE_DATA_1(write_ptr,0);
    WRITE_DATA_1(write_ptr,0);
    WRITE_DATA_1(write_ptr,73);
    WRITE_DATA_1(write_ptr,69);
    WRITE_DATA_1(write_ptr,78);
    WRITE_DATA_1(write_ptr,68);
    WRITE_DATA_1(write_ptr,174);
    WRITE_DATA_1(write_ptr,66);
    WRITE_DATA_1(write_ptr,96);
